        ...
        if text[1] == '[':
            ...
            if match:
                ...
                if command == 'A':  # cursor up
                    ...
                    while i < len(params):
                        ...
                        if param == 0:
                            ...
                            if i + 2 < len(params) and params[i + 1] == 5:
                                ...
                                ansi_parts.append(f'38;2;{params[i + 2]};{params[i + 3]};{params[i + 4]}')
                                i += 4
                        elif param == 48:
                            if i + 2 < len(params) and params[i + 1] == 5:
                                ...
                                ansi_parts.append(f'48;2;{params[i + 2]};{params[i + 3]};{params[i + 4]}')
                                i += 4
                        i += 1
                    ...
                    n = params[0] if params else 1
                    for _ in range(n):
                        screen.buffer[screen.cursor_y].insert(screen.cursor_x, (' ', ''))
                    ...
                    n = params[0] if params else 1
                    for _ in range(n):
                        screen.buffer.insert(screen.cursor_y, [(' ', '') for _ in range(screen.width)])
                    ...
                    for _ in range(n):
                        if screen.cursor_y < len(screen.buffer):
                            ...
                            screen.buffer.append([(' ', '') for _ in range(screen.width)])
